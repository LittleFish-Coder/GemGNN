...
\textbf{Cross-Entropy with Label Smoothing:} The default approach employs cross-entropy loss with label smoothing ($\alpha = 0.1$) to prevent overconfident predictions in few-shot scenarios:
\begin{equation}
