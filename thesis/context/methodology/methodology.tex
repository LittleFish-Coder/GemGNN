...
\textbf{Tone Distribution Strategy:} For each news article, we generate exactly 20 synthetic interactions distributed across three distinct emotional tones:
\begin{enumerate}
