...
try:
    ...
    original_dataset = load_dataset("LittleFish-Coder/Fake_News_GossipCop",
    ...
    print(f"FATAL: Failed to load original dataset 'LittleFish-Coder/Fake_News_GossipCop'. Error: {e}")
    exit()
...
try:
    ...
    repo_name = "LittleFish-Coder/Fake_News_GossipCop"
