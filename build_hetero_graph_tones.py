...
class HeteroGraphBuilder:
    ...
    def _get_selected_tones(self):
        """Get the list of tones to include based on tones_selection."""
        if self.tones_selection == 0:  # All tones
            ...
            raise ValueError(f"Invalid tones_selection: {self.tones_selection}. Must be 0-6.")

    def _get_tones_suffix(self):
        """Get the suffix for naming based on tones_selection."""
    ...
    def _filter_interactions_by_tone(self, embeddings_list, tones_list):
        """Filter interaction embeddings and tones based on selected tones."""
...
def parse_arguments():
    ...
    parser.add_argument("--tones_selection", type=int, default=DEFAULT_TONES_SELECTION, choices=[0, 1, 2, 3, 4, 5, 6], help="Tone selection for ablation study: 0=all, 1=neutral, 2=affirmative, 3=skeptical, 4=neutral+affirmative, 5=neutral+skeptical, 6=affirmative+skeptical")
